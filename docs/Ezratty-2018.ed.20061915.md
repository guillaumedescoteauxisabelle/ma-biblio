...
>L’IA est un ensemble de techniques permettant de résoudre des problèmes complexes en s’inspirant de mécanismes cognitifs humains, agissant de  manière opérationnelle en fonction de faits, données et expériences, et capables d’atteindre de manière  optimaleun ou plusieurs objectifs donnés.
...
L'intelligence artificielle pourrait générer des règles.

qu'est-ce qu'un arbre de décision?

il est possible d'utiliser l'intelligence artificielle pour faire des simulations sans relation avec la réalité pour tester les resultats.
